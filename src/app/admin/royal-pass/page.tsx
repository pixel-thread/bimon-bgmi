            ...
            {isLoading ? (
                ...
                <div className="grid gap-3 grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
                        ...
                        <div className="min-w-0">
                            <p className="text-xs sm:text-sm text-muted-foreground truncate">UC Rewarded</p>
                            <p className="text-xl sm:text-2xl font-bold text-orange-500">{stats?.summary?.totalUCRewarded || 0} UC</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
                            ...
                            {stats.subscribers.map((sub) => (
                                <div key={sub.id} className="rounded-xl bg-zinc-100 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700/50 p-4 space-y-3">
                                    ...
                                    <div className="grid grid-cols-3 gap-2 text-sm">
                                        <div className="bg-white dark:bg-zinc-900/50 rounded-lg p-2">
                                        ...
                                        <div className="bg-white dark:bg-zinc-900/50 rounded-lg p-2">
                                            <p className="text-muted-foreground text-xs">UC Earned</p>
                                            <p className="font-medium text-green-500">{sub.streakUCEarned}</p>
                                        </div>
                                    </div>
                                </div>
                            ))}
                            ...
                            <Table>
                                <TableHeader>
                                    <TableRow className="border-zinc-200 dark:border-zinc-800">
                                        ...
                                        <TableHead className="text-center">UC Earned</TableHead>
                                    ...
                                    {stats.subscribers.map((sub) => (
                                        <TableRow key={sub.id} className="border-zinc-200 dark:border-zinc-800">
                                            ...
                                            <TableCell className="text-center">
                                                <span className="flex items-center justify-center gap-1 font-medium text-orange-500">
                                                    <Flame className="h-4 w-4" />
                                                    {sub.streak}
                                                </span>
                                            </TableCell>
                                            <TableCell className="text-center font-medium text-green-500">
                                                {sub.streakUCEarned} UC
                                            </TableCell>
                                            <TableCell className="text-center">
                                                <Badge
                                                    variant="outline"
