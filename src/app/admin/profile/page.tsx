...
import {
    ...
    User, Target, Skull, Swords, TrendingUp, Settings, Shield
} from "lucide-react";
...
export default function AdminProfilePage() {
    ...
    // Fetch transfers (only if has player record)
    ...
    // Fetch notifications (only if has player record)
    ...
    return (
        <div className="space-y-6">
            ...
            <Tabs defaultValue={hasPlayerRecord ? "overview" : "account"} className="w-full">
                <TabsList className={`grid w-full max-w-md ${hasPlayerRecord ? "grid-cols-2" : "grid-cols-1"}`}>
                    {hasPlayerRecord && (
                ...
                {/* Overview Tab - Only for admins with player records */}
                {hasPlayerRecord && (
