...
import { CombinedTeamData, Player } from "@/src/lib/types";
          ...
          <Card className="p-3 shadow-sm border-none bg-background dark:bg-neutral-900 text-foreground">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <Label htmlFor="player1-ign" className="text-xs min-w-[80px]">
                  Player 1 IGN
                </Label>
                <Input
                  id="player1-ign"
              ...
              <div className="flex items-center gap-2">
                <Label htmlFor="player2-ign" className="text-xs min-w-[80px]">
                  Player 2 IGN
                </Label>
                <Input
                  id="player2-ign"
