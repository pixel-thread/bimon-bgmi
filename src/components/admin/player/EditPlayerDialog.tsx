...
//   onClose: () => void;
//   player: PlayerT | null;
//   onSave: (player: PlayerT) => Promise<boolean>;
...
//   const { user } = useAuth();
//   const [editedPlayer, setEditedPlayer] = React.useState<PlayerT | null>(null);
...
//       setBanReason(player.playerBanned?.banReason || "");
//       setBanDuration(player.playerBanned?.banDuration || 4);
...
//         Banned ({player.playerBanned?.banDuration} tournaments)
//       </Badge>
//     );
//   };
