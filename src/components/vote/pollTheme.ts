// Shared poll theme configuration based on participant count
...
export const getPollTheme = (participantCount: number): PollTheme | null => {
    if (participantCount >= 60) {
        ...
        return {
            ...
            dialogHeader: 'bg-gradient-to-r from-purple-500 via-pink-500 to-purple-600',
            dialogIcon: 'bg-purple-500',
            dialogBorder: 'border-purple-300 dark:border-purple-700',
            progressBar: 'bg-purple-500',
            voterCard: 'bg-purple-50 dark:bg-purple-900/20',
        };
        ...
        return {
            ...
            dialogHeader: 'bg-gradient-to-r from-red-500 via-orange-500 to-red-600',
            dialogIcon: 'bg-red-500',
            dialogBorder: 'border-red-300 dark:border-red-700',
            progressBar: 'bg-red-500',
            voterCard: 'bg-red-50 dark:bg-red-900/20',
        };
        ...
        return {
            ...
            dialogHeader: 'bg-gradient-to-r from-blue-500 via-cyan-400 to-blue-600',
            dialogIcon: 'bg-blue-500',
            dialogBorder: 'border-blue-300 dark:border-blue-700',
            progressBar: 'bg-blue-500',
            voterCard: 'bg-blue-50 dark:bg-blue-900/20',
        };
        ...
        return {
            ...
            dialogHeader: 'bg-gradient-to-r from-emerald-500 via-green-400 to-emerald-600',
        ...
        return {
            ...
            dialogHeader: 'bg-gradient-to-r from-amber-500 via-yellow-400 to-orange-400',
            dialogIcon: 'bg-amber-500',
            dialogBorder: 'border-amber-300 dark:border-amber-700',
            progressBar: 'bg-amber-500',
            voterCard: 'bg-amber-50 dark:bg-amber-900/20',
        };
        ...
        return {
            ...
            dialogHeader: 'bg-gradient-to-r from-slate-500 via-slate-400 to-gray-500',
            dialogIcon: 'bg-slate-500',
            dialogBorder: 'border-slate-300 dark:border-slate-700',
            progressBar: 'bg-slate-500',
            voterCard: 'bg-slate-50 dark:bg-slate-900/20',
        };
    }
...
export const calculateParticipantCount = (playersVotes: { vote: string }[] | undefined): number => {
    ...
    const inVotes = playersVotes.filter(v => v.vote === 'IN').length;
