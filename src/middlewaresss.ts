...
//     pathname.match(
//       /\.(jpg|jpeg|png|gif|svg|ico|webp|js|css|woff|woff2|ttf|eot)$/,
//     )
//   ) {
//     return NextResponse.next();
//   }

//   const { requiresAuth, requiredAccess, redirectTo } =
...
//         !["super_admin"].includes(authState.role || "")
//       ) {
...
//       if (
//         authState.authType !== "firebase" ||
//         !["super_admin", "teams_admin"].includes(authState.role || "")
//       ) {
//         return NextResponse.redirect(new URL("/tournament", request.url));
//       }
//       break;
