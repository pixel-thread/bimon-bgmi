...
import { canAccessFullAdmin, canAccessTeamsAdmin } from "@/config/adminAccess";
...
export default function ProtectedRoute({
  ...
  }, [loading, isAuthorized, role, playerUser, authType, isPlayer, router, redirectTo, requiredAccess, isRedirecting]);
