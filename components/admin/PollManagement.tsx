...
import { Poll, PollVote, TournamentConfig } from "@/lib/types";
...
import { VotersDialog } from "@/components/vote/VotersDialog";
import { WhatsAppPollCard } from "@/components/vote/WhatsAppPollCard";
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="outline"
          className={`flex justify-between items-center ${className || "w-full"}`}
        >
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 items-start">
                    ...
                    <span className="text-xs text-gray-400 sm:self-center">or</span>
