...
export default function OverallStandingModal({
  ...
  if (!visible || selectedMatch === "") return null;
  ...
  const shareImage = async () => {
    ...
    const element = document.getElementById("shareable-content") as HTMLDivElement | null;
    if (!element) return;
    ...
    try {
      ...
      downloadLink.download = `${tournamentTitle.replace(/\s+/g, "-")}-standings-match-${selectedMatch}.png`;
