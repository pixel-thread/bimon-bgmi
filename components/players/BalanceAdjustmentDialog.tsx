        ...
        <div className="flex flex-col gap-4 overflow-y-auto max-h-[70vh]">
          ...
          <div className="space-y-2">
            ...
            <RadioGroup
              ...
              onValueChange={(value: "credit" | "debit") => handleTransactionTypeChange(value)}
              className="grid grid-cols-2 gap-3 w-full"
            >
              <div 
                onClick={() => !isAdjustingBalance && handleTransactionTypeChange('credit')}
              ...
              >
                <RadioGroupItem value="credit" id="credit" disabled={isAdjustingBalance} />
                <Label htmlFor="credit" className="font-normal cursor-pointer select-none">Credit</Label>
              </div>
              <div 
                onClick={() => !isAdjustingBalance && handleTransactionTypeChange('debit')}
                className={`flex items-center justify-center gap-2 w-full rounded-md border py-2 cursor-pointer transition-colors ${
              ...
              >
                <RadioGroupItem value="debit" id="debit" disabled={isAdjustingBalance} />
                <Label htmlFor="debit" className="font-normal cursor-pointer select-none">Debit</Label>
              </div>
            </RadioGroup>
          </div>
