...
import { calculateRemainingBanDuration, formatRemainingBanDuration } from "@/utils/banUtils";
                    ...
                    <p className="text-sm text-red-300">
                      ...
                      {(() => {
                        ...
                        if (banInfo.isExpired) {
                          return <span className="text-green-400 font-medium">Ban has expired</span>;
                        }
                        return formatRemainingBanDuration(banInfo.remainingDuration || 0);
                      })()}
                    </p>
                    <p className="text-sm text-red-300">
